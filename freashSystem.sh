...
nala install flatpak libqt5svg5 qml-module-qtquick-controls qml-module-qtquick-controls2 feh bspwm sxhkd kitty rofi polybar picom thunar network-manager nitrogen lxpolkit x11-xserver-utils unzip yad wget pulseaudio pavucontrol sddm toucheeg -y
